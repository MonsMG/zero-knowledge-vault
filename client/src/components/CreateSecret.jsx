...
export default function CreateSecret() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/img/like.jpg')" }}
    >
      <div className="absolute inset-0 bg-black/50 z-0"></div>
      <div className="w-full max-w-md bg-slate-800 p-8 backdrop-blur-md rounded-xl shadow-2xl border border-slate-700 relative z-10">
        ...
        {!generatedLink ? (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-slate-300 mb-2 font-mono">
                Your Secret Message
              </label>
              <textarea
                value={message}
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-slate-400 text-sm">
              Send this link to anyone. It will self-destruct after viewing.
            </p>
